...
public class Request implements Parcelable {
    ...
    private       Class<? extends Operation> mOperationClass         = null;
    ...
    private       int                        mPriority               = Priority.NORMAL.ordinal();
    ...
    public Request(Class clazz) {
        ...
        this.mOperationClass = clazz;
    }

    public Class<? extends Operation> getOperationClass() {
        return mOperationClass;
    }
    ...
    public Priority getPriority() {
        return Priority.valueOf(mPriority);
    }
    ...
    /**
     * Add a Serializable parameter to the request, replacing any existing value for the given name.
     *
     * @param name  The parameter name.
     * @param value The parameter value.
     * @return This RequestData.
     */
    public Request put(String name, Serializable value) {
        removeFromRequestData(name);
        mParamList.add(name);
        mTypeList.add(TYPE_SERIALIZABLE);
    ...
    public Serializable getSerializable(String name) {
        return mBundle.getSerializable(name);
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof Request) {
            ...
            if (mOperationClass != oParams.mOperationClass) {
                return false;
            }
            ...
            for (int i = 0, length = mParamList.size(); i < length; i++) {
                ...
                switch (mTypeList.get(i)) {
                    ...
                    case TYPE_SERIALIZABLE:
                        if (!safeEquals(mBundle.getSerializable(param),
                                oParams.mBundle.getSerializable(param))) {
                            return false;
                        }
                        break;
                    default:
    ...
    public int hashCode() {
        ...
        objectList.add(mOperationClass);
//        objectList.add(mRequestType);
    ...
    private Request(final Parcel in) {
        mOperationClass = (Class) in.readSerializable();
...
//        dest.writeInt(mRequestType);
        dest.writeSerializable(mOperationClass);
