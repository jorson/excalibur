...
import com.nd.hy.android.core.net.http.worker.HttpClientWorker;
import com.nd.hy.android.core.net.http.worker.HttpURLConnectionWorker;
import com.nd.hy.android.core.net.http.worker.HttpWorker;
